...
tagged_rule(communication_app_tag, {
    "discord|Discord|equibop|Equibop|vesktop|Vesktop|legcord|Legcord|webcord|WebCord", -- Discord clients
    "whatsapp|WhatsApp|whatsapp-for-linux"                                              -- Whatsapp
}, "class")
tagged_rule(todo_app_tag, {
    "todoist|Todoist|com.todoist.Todoist" -- Todoist
}, "class")
