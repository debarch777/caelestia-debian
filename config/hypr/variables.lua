...
return {
    ...
    kbWhatsapp                 = "SUPER + ALT + D",
    kbHandySTT                 = "CTRL + Space",
    kbHandySTTPostProcess      = "CTRL + SHIFT + Space",

    -- Wallpapers
    kbWallpaperRandom          = "SUPER + ALT + W",
    kbWallpaperSelect          = { "SUPER + SHIFT + W", "CTRL + SHIFT + W" },
